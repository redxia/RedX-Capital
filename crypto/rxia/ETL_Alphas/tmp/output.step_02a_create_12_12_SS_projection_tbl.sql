...
--------------------------------------------------------------------------------
-- CREATE OR REPLACE estimator_12_04_CSII_panel_20170727_rx
...
-- 0:00:01.169153
-- 01a01122-0502-e9ac-0000-0f7505f328fa
-- Table ESTIMATOR_12_04_CSII_PANEL_20170727_RX successfully created.

------------------------------------------------------------------------------------------
--- CREATE OR REPLACE estimator_12_05_CSII_summations_20170727_rx
--- Linear regression
------------------------------------------------------------------------------------------
...
-- 0:00:01.447072
-- 01a01122-0502-e9ac-0000-0f7505f328fe
-- Table ESTIMATOR_12_05_CSII_SUMMATIONS_20170727_RX successfully created.

----------------------------------------------------------------------------------------
--- CREATE OR REPLACE estimator_12_06_CSII_slope_20170727_rx
----------------------------------------------------------------------------------------
...
-- 0:00:01.055197
-- 01a01122-0502-e8ec-0000-0f7505f31d1e
-- Table ESTIMATOR_12_06_CSII_SLOPE_20170727_RX successfully created.

---------------------------------------------------------------------------------------------
--- CREATE OR REPLACE estimator_12_07_CSII_intercept_20170727_rx
---------------------------------------------------------------------------------------------
...
from t;
-- 0:00:01.002796
-- 01a01122-0502-e8ec-0000-0f7505f31d22
-- Table ESTIMATOR_12_07_CSII_INTERCEPT_20170727_RX successfully created.

---------------------------------------------------------------------------------------------
--- CREATE OR REPLACE estimator_12_08_CSII_new_factor_20170727_rx
---------------------------------------------------------------------------------------------
...
-- 0:00:01.179288
-- 01a01123-0502-e983-0000-0f7505f2ede2
-- Table ESTIMATOR_12_08_CSII_NEW_FACTOR_20170727_RX successfully created.

-- select * from estimator_12_08_CSII_new_factor_20170727_rx;
------------------------------------------------------------------------------------------------
-- CREATE OR REPLACE estimator_12_09_CSII_quarterly_estimate_20170727_rx
--quarterly estimate
------------------------------------------------------------------------------------------------
...
-- 0:00:01.187588
-- 01a01123-0502-e9eb-0000-0f7505f3330a
-- Table ESTIMATOR_12_09_CSII_QUARTERLY_ESTIMATE_20170727_RX successfully created.

----------------------------------------------------------------------------------------------------
-- CREATE OR REPLACE estimator_12_10_CSII_join_official_revenue_20170727_rx
...
-- 0:00:01.495522
-- 01a01123-0502-e983-0000-0f7505f2ede6
-- Table ESTIMATOR_12_10_CSII_JOIN_OFFICIAL_REVENUE_20170727_RX successfully created.

------------------------------------------------------------------------------------
-- CREATE OR REPLACE estimator_12_11_CSII_scaling_factor_20170727_rx
--scaling factor
------------------------------------------------------------------------------------
...
left join u;
-- 0:00:01.874077
-- 01a01123-0502-e9ac-0000-0f7505f32902
-- Table ESTIMATOR_12_11_CSII_SCALING_FACTOR_20170727_RX successfully created.

------------------------------------------------------------------------------------------
-- CREATE OR REPLACE estimator_12_12_CSII_scaled_estimate_20170727_rx
...
where 1 = 1;
-- 0:00:01.252962
-- 01a01123-0502-e8ec-0000-0f7505f31d26
-- Table ESTIMATOR_12_12_CSII_SCALED_ESTIMATE_20170727_RX successfully created.
...
order by 1,2 asc;
-- 0:00:00.525202
-- 01a01123-0502-e8d4-0000-0f7505f30b2e
-- RESULT []
