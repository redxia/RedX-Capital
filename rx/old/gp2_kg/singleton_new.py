...
********************************************************************************
     Module: gp.singleton
Description: Prevents multiple instances
      Usage: Create and hold instance of SingletonInstance.  Exception will be
             thrown if already in use by another process.
...
class SingleInstance:
    ...
    def __init__(self, flavor_id=""):
        ...
        if sys.platform == 'win32':
            ...
            import fcntl
            self.fp = os.open(self.lockfile, 'w')
            self.fp.flush()
            try:
