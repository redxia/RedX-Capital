...
def run_sql_step(filename):
    '''
    NOTE -- Adding logging to trace outputs
    '''
...
def run_jupyter_step(filename):
    ...
    ## TODO: Review need for this step
...
def run_py_step(filename):
    ...
    ## NOTE -- Adjusting for Linux
    ## TODO: Print out filename; review need for this step
...
def run_steps():
    ## NEW -- Reviewing the content in settings
    # print('CLI ARG LENGTH: ', len(sys.argv))
    # print('CLI ARGUMENTS: ', str(sys.argv))
    
    # print('SETTINGS_MAP: ', settings_map)
    # print('SETTINGS: ', settings)
    # print('SETTINGS_FILE: ', settings_file)
    
    ## NEW -- Inspecting variables from job.py
    # TODO: Trace JOB_OUTPUT_URL // find how logs are delivered to S3
    print(': ', gp.job.__PARENT_FOLDER, '\n')
    # print('__PARENT_FOLDER: ', gp.job.__PARENT_FOLDER, '\n')
    # print('__JOB_FOLDER: ', gp.job.__JOB_FOLDER, '\n')
    # print('__SNOWFLAKE_INTERNAL: ', gp.job.__SNOWFLAKE_INTERNAL, '\n')
    # print('__S3_INTERNAL: ', gp.job.__S3_INTERNAL, '\n')
    # print('__BUCKET: ', gp.job.__BUCKET, '\n')
    # print('__PATH: ', gp.job.__PATH, '\n')
    # print('JOB_OUTPUT_URL: ', gp.job.JOB_OUTPUT_URL, '\n')
    
    ### TEST - Adding function + passing result into glob
    ...
    log.info(f'CONTENTS IN CURRENT DIRECTORY: {os.listdir()}')
    
    steps = glob(f'{project_name}/{job_name}/steps/**/*.*', recursive=True)
    steps1 = glob(f'{project_name}/{job_name}/steps')
